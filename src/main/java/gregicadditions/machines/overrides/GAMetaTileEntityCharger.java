...
public class GAMetaTileEntityCharger extends GATieredMetaTileEntity {

    private final int inventorySize;

    public GAMetaTileEntityCharger(ResourceLocation metaTileEntityId, int tier, int inventorySize) {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new GAMetaTileEntityCharger(metaTileEntityId, getTier(), inventorySize);
    }
