...
public class GASimpleMachineMetaTileEntity extends GAWorkableTieredMetaTileEntity {
    ...
    public GASimpleMachineMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, OrientedOverlayRenderer renderer, int tier) {
        this(metaTileEntityId, recipeMap, renderer, tier, true);
    }

    public GASimpleMachineMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, OrientedOverlayRenderer renderer, int tier, boolean hasFrontFacing) {
    ...
    protected ModularUI.Builder createGuiTemplate(EntityPlayer player) {
        ...
        if(workable.recipeMap instanceof gregtech.api.metatileentity.SimpleMachineMetaTileEntity.RecipeMapWithConfigButton) {
            leftButtonStartX += ((gregtech.api.metatileentity.SimpleMachineMetaTileEntity.RecipeMapWithConfigButton) workable.recipeMap).getLeftButtonOffset();
            rightButtonStartX -= ((gregtech.api.metatileentity.SimpleMachineMetaTileEntity.RecipeMapWithConfigButton) workable.recipeMap).getRightButtonOffset();
        }
